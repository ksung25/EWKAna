...
#ifndef MITPHYSICS_UTILS_ELECTRONENERGYSMEARINGSCALING_H
#define MITPHYSICS_UTILS_ELECTRONENERGYSMEARINGSCALING_H
  ...
  class ElectronEnergySmearingScaling {
	...
	k22Jan2013ReReco          // 2012 Data
      ...
      std::pair<double,double> evaluate(
        const Electron     *ele,       // pointer to electron object
